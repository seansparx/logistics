/*------------------------------------------------------------------------
# JA Sanidine II for Joomla 1.5 - Version 1.0 - Licence Owner JA107844
# ------------------------------------------------------------------------
...
function jasdl_initJAScriptDLMenu() {
	...
	{
		actitem = document.getElementById("jasdl-mainnav"+jasdl_activemenu[1].toString())
		if (actitem)
		{
			if (actitem.className) actitem.className += " active"; else actitem.className = "active";
		}	
		jasdl_recover = jasdl_activemenu[1]
	}
	if (jasdl_activemenu[1]) {
