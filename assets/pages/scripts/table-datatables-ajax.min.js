...
$(document).ready(function() {
    ...
    $('#date_filter_campaign_variants_brand_opti').val(moment().startOf(('day')) + "###" + moment());
...
//* Custom Column Search Campaign Variant *//
   ...
   //FOR BRAND OPTIMIZATION /////////// 
    ...
    //FOR FINANCE OPTIMIZATION
     ...
     $('#date_filter_campaign_variants_finance').val(moment().startOf(('day')) + "###" + moment());
   ...
   // Remove the formatting to get integer data for summation
     ...
     // Total ROI over this page
      ...
      // Total ROI over this page
       ...
       // Update footer
            $( api.column( 11 ).footer() ).html(clickSoldlead);
            $( api.column( 2 ).footer() ).html(clickTotal);
            $( api.column( 3 ).footer() ).html(clickConvert);
          //  $( api.column( 5 ).footer() ).html(clickPayout);
            $( api.column( 7 ).footer() ).html(clickRevenue);
            $( api.column( 6 ).footer() ).html(clickCost);
            $( api.column( 8 ).footer() ).html(clickProfit);
           // totalroi = (clickProfit/clickCost)*100;
               // clickroii = clickRoi + "%";
            // $( api.column( 9 ).footer() ).html(clickroii);
             
            if(clickTotal!= 0 && clickConvert!= 0)
            {
                crc = (clickConvert/clickTotal)*100;
                $( api.column( 4 ).footer() ).html(crc.toPrecision(4)+"%");
            }else{
                $( api.column( 4 ).footer() ).html(0+"%");
            }
            if(clickProfit!= 0 && clickCost!= 0)
            {
                totalroi = (clickProfit/clickCost)*100;
                $( api.column( 9 ).footer() ).html(totalroi.toPrecision(4)+"%");
            }else{
                $( api.column( 9 ).footer() ).html(0+"%");
            }
            $( api.column( 12 ).footer() ).html(duplicate);
            $( api.column( 13 ).footer() ).html(unsold);
            $( api.column( 14 ).footer() ).html(reject);
            $( api.column( 10 ).footer() ).html(ttl_leads);
            
            if( clickCost!= 0 && ttl_leads!= 0)
            {
                ttl_cpa = (clickCost/ttl_leads).toPrecision(4);
            }else
            {
                ttl_cpa = 0
            }
            
            $( api.column( 5 ).footer() ).html(ttl_cpa);
...
//* Custom Column Search Campaign Variant *//
    ...
    $('#date_filter').val(moment().startOf(('day')) + "###" + moment());
...
$(document).ready(function() {
    ...
    $('#date_filter_campaign').val(moment().startOf(('day')) + "###" + moment());
...
$(document).ready(function() {
    ...
    $('#date_filter_campaign_variants').val(moment().startOf(('day')) + "###" + moment());
...
$(document).ready(function() {
    ...
    $('#date_filter_main_db').val(moment().startOf(('day')) + "###" + moment());
    //alert($('#date_filter_campaign').val());
...
//* Custom Column Search *//
    ...
    $('#datatable_maindb').on('keyup change','.maindb_soldid', function() {
...
//* Custom Column Search for network name *//
    ...
    $('#datatable_maindb').on('keyup change','.maindb_network', function() {
...
//* Custom Column Search for last name *//
    ...
    $('#datatable_maindb').on('keyup change','.maindb_data_last_name', function() {
...
//* Custom Column Search *//
    ...
    $('#datatable_maindb').on('keyup change','.maindb_id', function() {
...
$('#datatable_maindb').on('keyup change','.maindb_error', function(){
    $("#main_db_error_ajax_search").val($(this).val());
    $('#datatable_maindb').dataTable().fnDraw(tbl_config3);
})
//* Custom search for error
//* Custom search for keyword
$('#datatable_maindb').on('keyup change','.maindb_keyword', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_source', function(){
    $("#main_db_source_ajax_search").val($(this).val());
    $('#datatable_maindb').dataTable().fnDraw(tbl_config3);
})
//* Custom search for Source
//* Custom search for Brand
$('#datatable_maindb').on('keyup change','.maindb_brand', function(){
    $("#main_db_brand_ajax_search").val($(this).val());
    $('#datatable_maindb').dataTable().fnDraw(tbl_config3);
})
//* Custom search for Brand
//* Custom search for IP
$('#datatable_maindb').on('keyup change','.maindb_ip', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cover_for', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_lp_id', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_main_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_main_sub_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_form_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_form_sub_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_step_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_step1_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_step1_subtext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_step2_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_step2_subtext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_step3_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_step3_subtext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_bullet_points1', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_bullet_points2', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_bullet_points3', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cta1_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cta1_sub_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cta2_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cta2_sub_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_about_headline', function(){
    $("#main_db_about_headline_ajax_search").val($(this).val());
    $('#datatable_maindb').dataTable().fnDraw(tbl_config3);
})
//* Custom search for about headline
//* Custom search for about text
$('#datatable_maindb').on('keyup change','.maindb_about_text', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_compare_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cta3_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cta3_subtext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_testimonial_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_testimonial_text', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_testimonial_info', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cta_dropdown_maintext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_cta_dropdown_subtext', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_congratulations_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_congratulations_sub_headline', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_congratulations_filled', function(){
...
$('#datatable_maindb').on('keyup change','.maindb_second_form_headline', function(){
...
$(document).ready(function() {
    ...
    $('#date_filter_missing_leads').val(moment().startOf(('day')) + "###" + moment());
    //alert($('#date_filter_campaign').val());
...
//* Custom Column Search *//
    ...
    $('#datatable_missingleads').on('keyup change','.missing_db_id', function() {
...
//* Custom Column Search *//
    ...
    $('#datatable_missingleads').on('keyup change','.missing_db_created_at', function() {
...
//* Custom Column Search *//
//* Custom search for error
$('#datatable_missingleads').on('keyup change','.missing_db_error', function(){
    $("#missing_db_error_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for error
//* Custom search for keyword
$('#datatable_missingleads').on('keyup change','.missing_db_keyword', function(){
...
//* Custom search for Source
$('#datatable_missingleads').on('keyup change','.missing_db_source', function(){
    $("#missing_db_source_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for Source
//* Custom search for Brand
$('#datatable_missingleads').on('keyup change','.missing_db_brand', function(){
    $("#missing_db_brand_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for Brand
//* Custom search for IP
$('#datatable_missingleads').on('keyup change','.missing_db_ip', function(){
...
//* Custom search for Cover for
$('#datatable_missingleads').on('keyup change','.missing_db_cover_for', function(){
...
//* Custom search for Type
$('#datatable_missingleads').on('keyup change','.missing_db_type', function(){
    $("#missing_db_type_ajax_search").val($(this).val());
   $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for Type
//* Custom search for Amount
$('#datatable_missingleads').on('keyup change','.missing_db_amount', function(){
    $("#missing_db_amount_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for Amount
//* Custom search for Amount
$('#datatable_missingleads').on('keyup change','.missing_db_length', function(){
    $("#missing_db_length_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for Amount
//* Custom search for first name
$('#datatable_missingleads').on('keyup change','.missing_db_first_name', function(){
    $("#missing_db_first_name_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for first name
//* Custom search for last name
$('#datatable_missingleads').on('keyup change','.missing_db_last_name', function(){
    $("#missing_db_last_name_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for last name
//* Custom search for first name
$('#datatable_missingleads').on('keyup change','.missing_db_address', function(){
    $("#missing_db_address_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for first name
//* Custom search for Post code
$('#datatable_missingleads').on('keyup change','.missing_db_postcode', function(){
    $("#missing_db_postcode_ajax_search").val($(this).val());
   $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for Post code
//* Custom search for dob
$('#datatable_missingleads').on('keyup change','.missing_db_dob', function(){
    $("#missing_db_dob_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for dob
//* Custom search for smoke
$('#datatable_missingleads').on('keyup change','.missing_db_smoke', function(){
    $("#missing_db_smoke_ajax_search").val($(this).val());
   $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for smoke
//* Custom search for Phone no
$('#datatable_missingleads').on('keyup change','.missing_db_phone_no', function(){
    $("#missing_db_phone_no_ajax_search").val($(this).val());
   $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for Phone no
//* Custom search for Email
$('#datatable_missingleads').on('keyup change','.missing_db_email', function(){
    $("#missing_db_email_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for Email
//* Custom search for match type
$('#datatable_missingleads').on('keyup change','.missing_db_match_type', function(){
    $("#missing_db_match_type_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for match type
//* Custom search for adposition
$('#datatable_missingleads').on('keyup change','.missing_db_adposition', function(){
    $("#missing_db_adposition_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for adposition
//* Custom search for device model
$('#datatable_missingleads').on('keyup change','.missing_db_device_model', function(){
    $("#missing_db_device_model_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for device model
//* Custom search for lp id
$('#datatable_missingleads').on('keyup change','.missing_db_lp_id', function(){
...
//* Custom search for main headline
$('#datatable_missingleads').on('keyup change','.missing_db_main_headline', function(){
...
//* Custom search for main sub headline
$('#datatable_missingleads').on('keyup change','.missing_db_main_sub_headline', function(){
...
//* Custom search for form headline
$('#datatable_missingleads').on('keyup change','.missing_db_form_headline', function(){
...
//* Custom search for form sub headline
$('#datatable_missingleads').on('keyup change','.missing_db_form_sub_headline', function(){
...
//* Custom search for step headline
$('#datatable_missingleads').on('keyup change','.missing_db_step_headline', function(){
...
//* Custom search for step1 maintext
$('#datatable_missingleads').on('keyup change','.missing_db_step1_maintext', function(){
...
//* Custom search for step1 subtext
$('#datatable_missingleads').on('keyup change','.missing_db_step1_subtext', function(){
...
//* Custom search for step2 maintext
$('#datatable_missingleads').on('keyup change','.missing_db_step2_maintext', function(){
...
//* Custom search for step2 subtext
$('#datatable_missingleads').on('keyup change','.missing_db_step2_subtext', function(){
...
//* Custom search for step3 maintext
$('#datatable_missingleads').on('keyup change','.missing_db_step3_maintext', function(){
...
//* Custom search for step3 subtext
$('#datatable_missingleads').on('keyup change','.missing_db_step3_subtext', function(){
...
//* Custom search for bullet points1
$('#datatable_missingleads').on('keyup change','.missing_db_bullet_points1', function(){
...
//* Custom search for bullet points2
$('#datatable_missingleads').on('keyup change','.missing_db_bullet_points2', function(){
...
//* Custom search for bullet points3
$('#datatable_missingleads').on('keyup change','.missing_db_bullet_points3', function(){
...
//* Custom search for cta1 maintext
$('#datatable_missingleads').on('keyup change','.missing_db_cta1_maintext', function(){
...
//* Custom search for cta1 subtext
$('#datatable_missingleads').on('keyup change','.missing_db_cta1_sub_maintext', function(){
...
//* Custom search for cta2 maintext
$('#datatable_missingleads').on('keyup change','.missing_db_cta2_maintext', function(){
...
//* Custom search for cta2 subtext
$('#datatable_missingleads').on('keyup change','.missing_db_cta2_sub_maintext', function(){
...
//* Custom search for about headline
$('#datatable_missingleads').on('keyup change','.missing_db_about_headline', function(){
    $("#missing_db_about_headline_ajax_search").val($(this).val());
    $('#datatable_missingleads').dataTable().fnDraw(tbl_config4);
})
//* Custom search for about headline
//* Custom search for about text
$('#datatable_missingleads').on('keyup change','.missing_db_about_text', function(){
...
//* Custom search for compare headline
$('#datatable_missingleads').on('keyup change','.missing_db_compare_headline', function(){
...
//* Custom search for cta3 maintext
$('#datatable_missingleads').on('keyup change','.missing_db_cta3_maintext', function(){
...
//* Custom search for cta3 subtext
$('#datatable_missingleads').on('keyup change','.missing_db_cta3_subtext', function(){
...
//* Custom search for testimonial headline
$('#datatable_missingleads').on('keyup change','.missing_db_testimonial_headline', function(){
...
//* Custom search for testimonial text
$('#datatable_missingleads').on('keyup change','.missing_db_testimonial_text', function(){
...
//* Custom search for testimonial info
$('#datatable_missingleads').on('keyup change','.missing_db_testimonial_info', function(){
...
//* Custom search for cta dropdown maintext
$('#datatable_missingleads').on('keyup change','.missing_db_cta_dropdown_maintext', function(){
...
//* Custom search for cta dropdown subtext
$('#datatable_missingleads').on('keyup change','.missing_db_cta_dropdown_subtext', function(){
...
//* Custom search for congratulations headline
$('#datatable_missingleads').on('keyup change','.missing_db_congratulations_headline', function(){
...
//* Custom search for congratulations subheadline
$('#datatable_missingleads').on('keyup change','.missing_db_congratulations_sub_headline', function(){
...
//* Custom search for congratulations filled
$('#datatable_missingleads').on('keyup change','.missing_db_congratulations_filled', function(){
...
//* Custom search for second form headline
$('#datatable_missingleads').on('keyup change','.missing_db_second_form_headline', function(){
