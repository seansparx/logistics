...
$(document).ready(function() {
    ...
    $('#date_filter_campaign_variants_brand_opti').val(moment() + "###" + moment());
   ...
   // Remove the formatting to get integer data for summation
    ...
    ), "0" != $("#data-report-range-camp-variant-brand-opti").attr("data-display-range") && $("#data-report-range-camp-variant-brand-opti span").html(moment().format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#data-report-range-camp-variant-brand-opti").show())
...
//* Custom Column Search Campaign Variant *//
   ...
   //FOR BRAND OPTIMIZATION /////////// 
    ...
    //FOR FINANCE OPTIMIZATION
     ...
     $('#date_filter_campaign_variants_finance').val(moment() + "###" + moment());
    ...
    ), "0" != $("#data-report-range-camp-variant-finance").attr("data-display-range") && $("#data-report-range-camp-variant-finance span").html(moment().format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#data-report-range-camp-variant-finance").show())
...
//* Custom Column Search Campaign Variant *//
    ...
    ), "0" != $("#data-report-range").attr("data-display-range") && $("#data-report-range span").html(moment().format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#data-report-range").show())
...
$(document).ready(function() {
    ...
    $('#date_filter_campaign').val(moment() + "###" + moment());
...
//            });
    ...
    ), "0" != $("#data-report-range-variant").attr("data-display-range") && $("#data-report-range-variant span").html(moment().format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#data-report-range-variant").show())
...
$(document).ready(function() {
    ...
    $('#date_filter_campaign_variants').val(moment() + "###" + moment());
...
//    });
    ...
    ), "0" != $("#data-report-range-camp-variant").attr("data-display-range") && $("#data-report-range-camp-variant span").html(moment().format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#data-report-range-camp-variant").show())
...
$(document).ready(function() {
    ...
    $('#date_filter_main_db').val(moment() + "###" + moment());
    //alert($('#date_filter_campaign').val());
...
//    });
    ...
    ), "0" != $("#data-report-range-maindb").attr("data-display-range") && $("#data-report-range-maindb span").html(moment().format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#data-report-range-maindb").show())
...
$(document).ready(function() {
    ...
    $('#date_filter_missing_leads').val(moment() + "###" + moment());
    //alert($('#date_filter_campaign').val());
 ...
 //*  Custom Date Range  *//
    ...
    ), "0" != $("#data-report-range-missinglead").attr("data-display-range") && $("#data-report-range-missinglead span").html(moment().format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#data-report-range-missinglead").show())
