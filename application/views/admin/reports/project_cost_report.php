    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Contract Cost Report</span>
                </li>
            </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-dark bold uppercase">Contract Cost Report</span>
                        </div>
                        <div class="actions">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="dd/mm/yyyy">
                                        ...
                                        <span class="input-group-btn">
                                            <a href="<?php echo site_url('admin/reports/project_cost'); ?>" class="btn btn-default"> Reset </a>
                                        </span>
                                    </div>
                                    <!-- /input-group -->
