                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Add Holiday</span>
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <form action="<?php echo site_url('admin/holiday/add'); ?>"  method="post" id="holiday_form"  class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="holiday_name" id="holiday_name" data-required="1" value="<?php echo set_value('holiday_name'); ?>" maxlength="50">
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group input-small input-daterange">
                                            <input type="text" name="holiday_date" id="holiday_date" value="<?php
                                                if (set_value('holiday_date')) {
                                                    echo set_value('holiday_date');
                                                } 
                                                else {
                                                    echo date('Y-m-d');
                                                }
