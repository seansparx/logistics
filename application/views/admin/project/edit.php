                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Edit Contract</span>
                        </div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="code" maxlength="50" id="code" value="<?php echo $details['code']; ?>" data-required="1" />
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="cust_name" maxlength="50" id="cust_name" value="<?php echo $details['customer_name']; ?>" data-required="1" />
