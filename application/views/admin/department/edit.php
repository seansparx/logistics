                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group  margin-top-20">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control"  maxlength="50" name="name" id="name" data-required="1" value='<?php echo $details['name']; ?>' />
                                                ...
                                                <div class="form-group  margin-top-20">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <textarea class="form-control" name="description" id="description" data-required="1" rows="4" cols="50" maxlength="500"><?php echo $details['description']; ?> </textarea>
