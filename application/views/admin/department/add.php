                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group  margin-top-20">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control" name="name" id="name" data-required="1" value="<?php echo set_value('name');?>" maxlength="50">
                                                ...
                                                <div class="form-group  margin-top-20">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <textarea class="form-control" name="description" id="description" data-required="1" rows="4" cols="50" maxlength="500"> <?php echo set_value('description');?> </textarea>
