                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" value="<?php echo set_value('regn_number'); ?>" name="regn_number" maxlength="50" id="regn_number" data-required="1" />
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="model" value="<?php echo set_value('model'); ?>" maxlength="50" id="model" data-required="1" />
