                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_services">
                                <thead>
                                    <tr role="row" class="heading">
                                        ...
                                        <th width="8%">Assign Hrs</th>
                                        <th width="8%">Working Hrs</th>
                                        <th width="8%">Extra Hrs</th>
                                    ...
                                    <tr class="filter" role="row">
                                        ...
                                        <td rowspan="1" colspan="1">
                                            <div class="margin-bottom-5 input-icon">
                                                ...
                                                <input type="text" placeholder="Hour" name="filter_assign_hours" class="filter_assign_hours form-control  form-filter input-sm"> </div>
                                        </td>
                                        <td rowspan="1" colspan="1">
                                            <div class="margin-bottom-5 input-icon">

                                                <input type="text" placeholder="Hour" name="filter_total_hours" class="filter_total_hours form-control  form-filter input-sm"> </div>
                                        </td>
                                        <td rowspan="1" colspan="1">
                                            <div class="margin-bottom-5 input-icon">

                                                <input type="text" placeholder="Hour" name="filter_extra_hours" class="filter_extra_hours form-control  form-filter input-sm"> </div>
                                        </td>
...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        $(".filter_extra_hours,.filter_total_hours").mask("99:99", {placeholder: "HH:MM"});
